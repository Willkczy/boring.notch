//
//  NotchHeaderIcons.swift
//  boringNotch — Agent Monitor (vibe-notch port)
//
//  Pixel-art header icons. Ported verbatim from vibe-notch's NotchHeaderView.swift
//  (the crab + permission/ready indicators). Used by the closed-notch glance
//  (AgentNotchIndicator) and the Agents-tab header.
//
