...
//
//  Markdown renderer using swift-markdown. Ported verbatim from vibe-notch.
//  Defines `MarkdownText` (used by the ported ChatView). NOTE: boringNotch's
//  old AgentConversationView also defined a `MarkdownText`; that file is removed
//  in the G4 chat port, so this is the single definition.
//
