...
//
//  Unified state model for a Claude session. Ported verbatim from vibe-notch.
//  In vibe this was driven by SessionStore; here our AgentSessionMonitor adapter
//  builds these from boringNotch's flat `Session` + ConversationParser output.
//
...
struct SessionState: Equatable, Identifiable, Sendable {
    ...
    /// All chat items for this session
