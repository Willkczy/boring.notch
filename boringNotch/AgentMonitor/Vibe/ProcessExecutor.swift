...
//
//  Shared utility for executing shell commands. Ported verbatim from vibe-notch
//  (logger subsystem renamed). Used by the tmux send-keys path (G5).
//
...
actor ProcessExecutor: ProcessExecuting {
    ...
    nonisolated static let logger = Logger(subsystem: "com.notchagent.app", category: "ProcessExecutor")
